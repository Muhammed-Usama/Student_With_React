  ...
  const [courses, setCourses] = useState("");
    ...
    try {
     ...
     if (studentData.courses && studentData.courses.length > 0) {
        const courseName = studentData.courses.join(" ");
                ...
                <div class="container-fluid">
                    ...
                    <div class="card card-primary card-outline ">
                        <div class="card-body box-profile">
                            ...
                            <h3 class="profile-username text-center">{student.name_en}</h3>

                            <p class="text-muted text-center">Student</p>

                            <ul class="list-group list-group-unbordered mb-3">
                                <li class="list-group-item">
                                    <b>Address</b> <Link class="float-right">{student.address_en}</Link>
                                </li>
                                <li class="list-group-item">
                                    <b>Mobile</b> <Link class="float-right">{student.mobile}</Link>
                                </li>
                                <li class="list-group-item">
                                    <b>Courses</b>                               
